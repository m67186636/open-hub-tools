# Gemini CLI Installer for Windows (Custom API URL)
# Usage: irm https://yoursite.com/tools/gemini-cli/install-custom.ps1 | iex

Clear-Host
$ErrorActionPreference = "Stop"

Write-Host "`n========================================" -ForegroundColor Cyan
Write-Host "   Gemini CLI 安装程序 (自定义配置)" -ForegroundColor Cyan
Write-Host "========================================`n" -ForegroundColor Cyan
...
Write-Host "[1/3] 检查 Gemini CLI 安装状态..." -ForegroundColor Cyan
...
# 步骤 2: 询问配置
Write-Host "`n[2/3] 配置环境变量..." -ForegroundColor Cyan

# 询问 API Base URL
Write-Host "请输入 API Base URL（留空则使用 Google 官方）:" -ForegroundColor Yellow
Write-Host "示例: https://generativelanguage.googleapis.com 或 https://your-proxy.com" -ForegroundColor Gray
...
if (-not [string]::IsNullOrWhiteSpace($baseUrl)) {
    ...
    Write-Host "不设置 GOOGLE_GEMINI_BASE_URL，将使用官方默认地址。" -ForegroundColor Gray
}
