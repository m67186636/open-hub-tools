#!/bin/bash
# Codex CLI Installer for Linux/macOS
# Usage: curl -fsSL https://yoursite.com/tools/codex-cli/install.sh | bash
...
echo "（获取地址: https://api.model-hub.cn 控制台 -> API令牌 -> 选择 codex专属 分组）"
